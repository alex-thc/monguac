...
/**
 * A trivial implementation of ShardingCatalogClient for host replica set.
 */
class ShardingCatalogClientHost : public ShardingCatalogClient {
public:
    ShardingCatalogClientHost(std::unique_ptr<DistLockManager> distLockManager);
    ~ShardingCatalogClientHost();
